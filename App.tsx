      ...
      {profileMenuOpen && <>
        ...
        <View style={styles.profileMenu}>
          <View style={styles.profileMenuHeader}>
            ...
            <Text style={styles.profileMenuRole}>ASSIGNED ROLE · {role.toUpperCase()}</Text>
          </View>
...
function InviteManager() {
  ...
  return <Card>
    ...
    <Text style={styles.muted}>Choose the employee role below. It is locked into the invitation and stated in the email. Every link works once and expires after 8 hours.</Text>
...
const styles = StyleSheet.create({
  ...
  percentagePresets: { flexDirection: 'row', gap: 8, marginTop: 5 }, percentagePreset: { minHeight: 38, minWidth: 54, borderRadius: 19, borderWidth: 1, borderColor: color.neutral[300], alignItems: 'center', justifyContent: 'center', paddingHorizontal: 11 }, percentagePresetActive: { backgroundColor: NAVY, borderColor: NAVY }, percentagePresetText: { color: NAVY, fontWeight: '800' }, percentagePresetTextActive: { color: color.neutral[0] },
